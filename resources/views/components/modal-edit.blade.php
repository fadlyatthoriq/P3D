<div class="modal modal-lg fade" id="modalUpdate{{ $d->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Update Data Wajib Pajak</h5>
                ...
                <form action="{{ route('data-pajak.update', $d->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="jenisusaha" id="jenisusaha"
                            aria-describedby="jenisusaha" placeholder="Jenis Usaha" value="{{ $d->jenisusaha }}"
                            required>
                    </div>
                    <div class="form-group">
                        <label for="latitude" class="form-label">Latitude</label>
                        <input type="text" class="form-control" name="latitude" id="latitude{{ $d->id }}"
                            aria-describedby="latitude" placeholder="Latitude" value="{{ $d->latitude }}" readonly>
                    </div>
                    <div class="form-group">
                        <label for="longitude" class="form-label">Longitude</label>
                        <input type="text" class="form-control" name="longitude" id="longitude{{ $d->id }}"
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenispendapatan" id="jenispendapatan" class="form-control" required>
                            ...
                            <option value="Penggantian atau Imbalan"
                                {{ old('jenispendapatan', $d->jenispendapatan) == 'Penggantian atau Imbalan' ? 'selected' : '' }}>
                                Penggantian atau Imbalan</option>
                            <option value="Hadiah"
                                {{ old('jenispendapatan', $d->jenispendapatan) == 'Hadiah' ? 'selected' : '' }}>Hadiah
                            </option>
                            <option value="Laba Usaha"
                                {{ old('jenispendapatan', $d->jenispendapatan) == 'Laba Usaha' ? 'selected' : '' }}>
                                Laba Usaha</option>
                            <option value="Keuntungan Penjualan"
                                {{ old('jenispendapatan', $d->jenispendapatan) == 'Keuntungan Penjualan' ? 'selected' : '' }}>
                                Keuntungan Penjualan</option>
                            <option value="Penerimaan Kembali"
                                {{ old('jenispendapatan', $d->jenispendapatan) == 'Penerimaan Kembali' ? 'selected' : '' }}>
                                Penerimaan Kembali</option>
                            <option value="Bunga"
                                {{ old('jenispendapatan', $d->jenispendapatan) == 'Bunga' ? 'selected' : '' }}>Bunga
                            </option>
                            <option value="Dividen"
                                {{ old('jenispendapatan', $d->jenispendapatan) == 'Dividen' ? 'selected' : '' }}>
                                Dividen</option>
                            <option value="Royalti"
                                {{ old('jenispendapatan', $d->jenispendapatan) == 'Royalti' ? 'selected' : '' }}>
                                Royalti</option>
                            <option value="Sewa"
                                {{ old('jenispendapatan', $d->jenispendapatan) == 'Sewa' ? 'selected' : '' }}>Sewa
                            </option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="teleponusaha" id="teleponusaha"
                            aria-describedby="teleponusaha" placeholder="No Telp Usaha" value="{{ $d->teleponusaha }}"
                            required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="namapemilik" id="namapemilik"
                            aria-describedby="namapemilik" placeholder="Nama Pemilik" value="{{ $d->namapemilik }}"
                            required>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="nikpemilik" id="nikpemilik"
                            aria-describedby="nikpemilik" placeholder="NIK Pemilik" value="{{ $d->nikpemilik }}"
                            required>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="jabatanpemilik" id="jabatanpemilik"
                            aria-describedby="jabatanpemilik" placeholder="Jabatan Pemilik"
                            value="{{ $d->jabatanpemilik }}" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="teleponpemilik" id="teleponpemilik"
                            aria-describedby="teleponpemilik" placeholder="No Telp Pemilik"
                            value="{{ $d->teleponpemilik }}" required>
                    </div>
